      ...
      children: [
        ...
        ActionCard(
          ...
          onTap: () => Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const StudentFeePage()),
          ),
        ),
        ActionCard(
        ...
        ActionCard(
          title: 'Co-curriculum',
          subtitle: 'Manage your modules and credit claim.',
    ...
    return BaseDashboard(
      ...
      children: [
        ...
        ActionCard(
          ...
          onTap: () => Navigator.of(context).push(
            MaterialPageRoute(builder: (context) => const SubjectApprovalsPage()),
          ),
        ),
        ActionCard(
          title: 'My Courses',
...
class TreasuryDashboard extends StatelessWidget {
  ...
  Future<void> _syncData(BuildContext context) async {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Updating Firestore...')),
    );
...
class PusatAdabDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseDashboard(
      title: 'Pusat ADAB Dashboard',
      name: name,
      roleLabel: 'Pusat ADAB',
      children: [
        ActionCard(
          title: 'Verify Claims',
          subtitle: 'Review, approve, or reject student co-curriculum claims.',
          icon: Icons.verified_user,
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => AdabClaimListPage(staff_id: userId),
              ),
            );
          },
        ),
